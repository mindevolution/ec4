...
class CsvExportService
{
     ...
     */
    public function setCustomerShopRepository(CustomerShopRepository $customerShopRepository)
    {
        $this->customerShopRepository = $customerShopRepository;
    }
     ...
     * @return \Doctrine\ORM\QueryBuilder
     */
    public function getCustomerShopQueryBuilder(Request $request)
    {
        $qb = $this->customerShopRepository
