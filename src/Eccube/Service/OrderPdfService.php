...
class OrderPdfService extends TcpdfFpdi
{
    ...
    protected function renderShopData()
    {
        ...
        // $logoFile = $this->eccubeConfig->get('eccube_html_dir').'/html/template/admin/assets/pdf/logo.png';
        //edit by gzy
        $logoFile = $this->eccubeConfig->get('eccube_html_dir').'/user_data/assets/pdf/logo.png';

        if (!file_exists($logoFile)) {
            $logoFile = $this->eccubeConfig->get('eccube_html_admin_dir').'/html/template/admin/assets/pdf/logo.png';
        }

        $this->Image($logoFile, 124, 40, 26);
    }
