...
final class EccubeEvents
{
    ...
    const ADMIN_CUSTOMER_SHOP_CSV_EXPORT = 'admin.customer.shop.csv.export';
    ...
    const ADMIN_CUSTOMER_SHOP_LEVEL_INDEX_COMPLETE = 'admin.customer.shop.level.index.complete';
    const ADMIN_CUSTOMER_LEVEL_DETAIL_INDEX_COMPLETE = 'admin.customer.level.detail.index.complete';
    // edit
    const ADMIN_SETTING_SHOP_PAYMENT_EDIT_INITIALIZE = 'admin.setting.shop.payment.edit.initialize';
    const ADMIN_CUSTOMER_SHOP_LEVEL_EDIT_INITIALIZE = 'admin.customer.shop.level.edit.initialize';
    const ADMIN_CUSTOMER_LEVEL_DETAIL_EDIT_INITIALIZE = 'admin.customer.level.detail.edit.initialize';
    const ADMIN_SETTING_SHOP_PAYMENT_EDIT_COMPLETE = 'admin.setting.shop.payment.edit.complete';
    const ADMIN_CUSTOMER_SHOP_LEVEL_EDIT_COMPLETE = 'admin.customer.shop.level.edit.complete';
    const ADMIN_CUSTOMER_LEVEL_DETAIL_EDIT_COMPLETE = 'admin.customer.level.detail.edit.complete';
    // imageAdd
    const ADMIN_SETTING_SHOP_PAYMENT_IMAGE_ADD_COMPLETE = 'admin.setting.shop.payment.image.add.complete';
    const FRONT_ENTRYSHOP_UPLOAD_FILE_ADD_COMPLETE = 'front.entryshop.upload.file.add.complete';
    const FRONT_ENTRYSHOP_UPLOAD_FILE2_ADD_COMPLETE = 'front.entryshop.upload.file2.add.complete';
    // delete
    ...
    const FRONT_MYPAGE_SHOP_INDEX_INITIALIZE = 'front.mypage.shop.index.initialize';
    ...
    const FRONT_ENTRYSHOP_INDEX_INITIALIZE = 'front.entryshop.index.initialize';
    const FRONT_SHOPEDIT_INDEX_INITIALIZE = 'front.shopedit.index.initialize';
    const FRONT_ENTRY_INDEX_COMPLETE = 'front.entry.index.complete';
    const FRONT_ENTRYSHOP_INDEX_COMPLETE = 'front.entryshop.index.complete';
    // activate
    ...
    const MAIL_CUSTOMER_SHOP_CONFIRM = 'mail.customer.shop.confirm';
