...
class ShippingType extends AbstractType
{
     ...
     */
    public function __construct(EccubeConfig $eccubeConfig, CustomerShopRepository $customerShopRepository, DeliveryRepository $deliveryRepository, DeliveryFeeRepository $deliveryFeeRepository)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) {
                ...
                $is_shop = false;
                $Deliveries_new = [];
                $CustomerShop = $this->customerShopRepository->getCustomerShopByCustomer($Shipping->getOrder()->getCustomer());
