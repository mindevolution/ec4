...
if (!class_exists('\Eccube\Entity\BaseInfo')) {
    ...
    class BaseInfo extends \Eccube\Entity\AbstractEntity
    {
         ...
         * @var string|null
         *
         * @ORM\Column(name="delivery_shop_free_amount", type="decimal", precision=12, scale=2, nullable=true, options={"unsigned":true})
         */
        private $delivery_shop_free_amount;
        ...
        /**
         * Set deliveryShopFreeAmount.
         *
         * @param string|null $deliveryShopFreeAmount
         *
         * @return BaseInfo
         */
        public function setDeliveryShopFreeAmount($deliveryShopFreeAmount = null)
        {
            $this->delivery_shop_free_amount = $deliveryShopFreeAmount;

            return $this;
        }

        /**
         * Get deliveryShopFreeAmount.
         *
         * @return string|null
         */
        public function getDeliveryShopFreeAmount()
        {
            return $this->delivery_shop_free_amount;
        }
