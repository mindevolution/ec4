...
use Symfony\Component\Validator\Mapping\ClassMetadata;
    ...
    {
    use \Plugin\MailMagazine4\Entity\CustomerTrait, \Plugin\ContactManagement4\Entity\Extension\CustomerTrait, \Plugin\PayPalCheckout\Entity\CustomerTrait;
    ...
    /**
         ...
         * @var \Doctrine\Common\Collections\Collection
         *
         * @ORM\OneToMany(targetEntity="Eccube\Entity\CustomerShop", mappedBy="Customer", cascade={"remove"})
         */
        ...
        public function __construct()
        {
            ...
            $this->CustomerShops = new \Doctrine\Common\Collections\ArrayCollection();
         ...
         * @return Customer
         */
        public function addCustomerShop(\Eccube\Entity\CustomerShop $customerShop)
        {
            $this->CustomerShops[] = $customerShop;
         ...
         * @return boolean TRUE if this collection contained the specified element, FALSE otherwise.
         */
        public function removeCustomerShop(\Eccube\Entity\CustomerShop $customerShop)
        {
            return $this->CustomerShops->removeElement($customerShop);
        }
         ...
         * @return \Doctrine\Common\Collections\Collection
         */
        public function getCustomerShops()
        {
