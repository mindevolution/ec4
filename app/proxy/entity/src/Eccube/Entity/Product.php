...
use Doctrine\ORM\Mapping as ORM;
    ...
    {
    use \Plugin\ApgRichEditor\Entity\ProductTrait, \Plugin\Maker4\Entity\ProductTrait, \Plugin\RefineAdminProductFavorite\Entity\ProductTrait, \Plugin\RelatedProduct4\Entity\ProductTrait;
    ...
    private $_calc = false;
         ...
         * Set shop_discount.
         *
         * @param string $shopDiscount
         *
         * @return Product
         */
        public function setShopDiscount($shopDiscount)
        {
