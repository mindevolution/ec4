 ...
 * Order
 *
 * @ORM\Table(name="plg_stripe_order")
 * @ORM\Entity(repositoryClass="Plugin\StripePaymentGateway\Repository\StripeOrderRepository")
 */
class StripeOrder
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="konbini_voucher_url", type="string", nullable=true)
     */
    private $konbini_voucher_url;
    ...
    public function getKonbiniVoucherUrl()
    {
        return $this->konbini_voucher_url;
    }
    public function setKonbiniVoucherUrl($konbini_voucher_url)
    {
        $this->konbini_voucher_url = $konbini_voucher_url;
        return $this;
    }
